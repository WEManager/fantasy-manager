                        ...
                        @foreach($leagues as $league)
                            <li>
                                @if ($league->status == 'ACTIVE')
                                    <svg title="{{ __('Ongoing') }}" class="bi bi-clock-history" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                @elseif($league->status == 'NOT_STARTED')
                                    <svg title="{{ __('Not started yet') }}" class="bi bi-info-circle" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
