...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Edit A Player') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ link_route('update_player', ['user' => $player]) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ $player->email }}" required>
