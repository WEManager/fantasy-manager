...
interface TournamentStatusIconProps {
  status: TournamentStatus
}

export function TournamentStatusIcon({ status }: TournamentStatusIconProps) {
  switch (status) {
    case 'ACTIVE':
      return (
        <svg
          ...
          fill="currentColor"
          viewBox="0 0 16 16"
          aria-label="activeStatusIcon"
        >
          <title id="activeStatusIcon">Ativo Status Icon</title>
          <path
            fillRule="evenodd"
    ...
    case 'NOT_DECIDED':
      return (
        <svg
          ...
          fill="currentColor"
          viewBox="0 0 16 16"
          aria-label="notStatusIcon"
        >
          <title id="finishedStatusIcon">Não Iniciado ou decidido status icon</title>
          <path
            fillRule="evenodd"
    ...
    case 'FINISHED':
      return (
        <svg
          ...
          fill="currentColor"
          viewBox="0 0 16 16"
          aria-label="finishedStatusIcon"
        >
          <title id="finishedStatusIcon">Finalizado status icon</title>
          <path
            fillRule="evenodd"
