...
class MatchEngine
{
  ...
  {
    for ($i = 1; $i < 12; $i++) {
      $this->hometeamLineup->{'player_' . $i} = Models\Player::find($this->hometeamLineup->{'player_' . $i});
      $this->awayteamLineup->{'player_' . $i} = Models\Player::find($this->awayteamLineup->{'player_' . $i});
    }
