...
final class GameDuelsEngine
{
    public static function headingDuelBetween($player1, $player2, $player1oopDisadvantage = false, $player2oopDisadvantage = false)
    {
        ...
        [$player1HeadingSkills, $totalSkills] = self::calculatePlayersHeadingSkills($player1, $player2, $player1oopDisadvantage, $player2oopDisadvantage);
    ...
    private static function calculatePlayersHeadingSkills($player1, $player2, $player1oopDisadvantage, $player2oopDisadvantage): array
    {
        ...
        return [$player1HeadingSkills, $totalSkills];
    }
}
